...
***Please Note*** Following is a Quick Guide only, You can also refer our [**Detailed Guide**](https://github.com/make2explore/ESP32-OpenThread-Command-Line-Example/tree/main/OT-CLI-TCP-UDP-demo) of demo of sending messages between devices using TCP and UDP with **flow diagrams** and **Topology**.
