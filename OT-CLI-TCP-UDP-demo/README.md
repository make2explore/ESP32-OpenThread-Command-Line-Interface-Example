...
Please first refer our [This Guide](https://github.com/make2explore/ESP32-OpenThread-Command-Line-Example/tree/main/OT-CLI) to setup the ESP devices for Thread Network TCP/UDP communication  
